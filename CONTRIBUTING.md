...
Prism is designed to be easy to get started with. In general, you needn't any third-party dependencies, unless building with a package manager solution such as vcpkg: in that instance, this document is probably not for you.
