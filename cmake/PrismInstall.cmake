...
if(DEFINED SKBUILD)
  ...
  set_source_files_properties("${_cffi_c}" PROPERTIES SKIP_LINTING ON)
...
set(PRISM_CONFIG_PKGCONFIG_DEPS "")
if(PRISM_LIB_TYPE STREQUAL "STATIC_LIBRARY")
  if(PRISM_SYSTEM_DEP_FIND_DEPENDS)
    list(JOIN PRISM_SYSTEM_DEP_FIND_DEPENDS "\n" PRISM_CONFIG_FIND_DEPS)
  endif()
  if(PRISM_PKGCONFIG_FIND_DEPENDS)
    list(JOIN PRISM_PKGCONFIG_FIND_DEPENDS "\n" _pkgconfig_joined)
    set(PRISM_CONFIG_PKGCONFIG_DEPS
...
if(WIN32 AND PRISM_LIB_TYPE STREQUAL "STATIC_LIBRARY")
  ...
  # The same two facts in a plain file, for consumers that do not build with
  # CMake and so never see prism-config.cmake. Each line is an import library
  # and the DLL it stands for; that DLL has to be delay loaded, or linking
  # prism statically turns every screen reader into a hard dependency and the
  # program will not start without all of them installed.
  set(_manifest "")
