...
if(NVDAController_ADDED)
  set(_nvda_arch_id "")
  if(MSVC AND DEFINED MSVC_CXX_ARCHITECTURE_ID)
    set(_nvda_arch_id "${MSVC_CXX_ARCHITECTURE_ID}")
  elseif(DEFINED CMAKE_C_COMPILER_ARCHITECTURE_ID)
    set(_nvda_arch_id "${CMAKE_C_COMPILER_ARCHITECTURE_ID}")
  else()
    set(_nvda_arch_id "${CMAKE_SYSTEM_PROCESSOR}")
  endif()
  string(TOLOWER "${_nvda_arch_id}" _nvda_arch_id_lc)
  if(_nvda_arch_id_lc MATCHES "arm64|aarch64|arm64ec")
