...
#define TSA_REQUIRES_SHARED(...)         TSA_ATTR(requires_shared_capability(__VA_ARGS__))
...
#define TSA_RELEASE_GENERIC(...)         TSA_ATTR(release_generic_capability(__VA_ARGS__))
#define TSA_TRY_ACQUIRE(...)             TSA_ATTR(try_acquire_capability(__VA_ARGS__))
#define TSA_TRY_ACQUIRE_SHARED(...)      TSA_ATTR(try_acquire_shared_capability(__VA_ARGS__))
...
#define TSA_GUARDED_BY(...)              _Guarded_by_(__VA_ARGS__)
#define TSA_PT_GUARDED_BY(...)           _Guarded_by_(__VA_ARGS__)
#define TSA_ACQUIRED_BEFORE(...)
#define TSA_ACQUIRED_AFTER(...)
#define TSA_REQUIRES(...)                _Requires_lock_held_(__VA_ARGS__)
#define TSA_REQUIRES_SHARED(...)         _Requires_shared_lock_held_(__VA_ARGS__)
#define TSA_EXCLUDES(...)                _Requires_lock_not_held_(__VA_ARGS__)
#define TSA_ACQUIRE(...)                 _Acquires_exclusive_lock_(__VA_ARGS__)
#define TSA_ACQUIRE_SHARED(...)          _Acquires_shared_lock_(__VA_ARGS__)
#define TSA_RELEASE(...)                 _Releases_exclusive_lock_(__VA_ARGS__)
#define TSA_RELEASE_SHARED(...)          _Releases_shared_lock_(__VA_ARGS__)
#define TSA_RELEASE_GENERIC(...)         _Releases_lock_(__VA_ARGS__)
