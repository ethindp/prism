...
BackendEnumerator::BackendEnumerator(
    FrozenRegistry *registry, PrismAvailabilityCallback callback,
    PrismAvailabilityBaselineCallback baseline_callback, void *userdata,
    std::uint32_t poll_interval_ms, std::uint32_t debounce_samples,
