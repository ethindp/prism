...
public abstract class AbstractTextToSpeechBackend {
    ...
    public abstract EnumSet<BackendFeatures> getFeatures();

    public abstract com.snapchat.djinni.Outcome<Unit, BackendError> initialize();

    public abstract com.snapchat.djinni.Outcome<Unit, BackendError> speak(java.nio.ByteBuffer text, boolean interrupt);

    public abstract com.snapchat.djinni.Outcome<Unit, BackendError> speakSsml(java.nio.ByteBuffer text, boolean interrupt);

    public abstract com.snapchat.djinni.Outcome<Unit, BackendError> speakToMemory(java.nio.ByteBuffer text, AudioCallback callback, long userdata);

    public abstract com.snapchat.djinni.Outcome<Unit, BackendError> speakToMemorySsml(java.nio.ByteBuffer text, AudioCallback callback, long userdata);

    public abstract com.snapchat.djinni.Outcome<Unit, BackendError> braille(java.nio.ByteBuffer text);

    public abstract com.snapchat.djinni.Outcome<Unit, BackendError> output(java.nio.ByteBuffer text, boolean interrupt);
