...
final class AVSpeechContextImpl: NSObject, AVSpeechSynthesizerDelegate {
    ...
    var audioCallback: (@convention(c) (UnsafeMutableRawPointer?, UnsafePointer<Float>?, Int, Int32, Int32) -> Void)?
...
private func withContext(_ ctx: UnsafeMutableRawPointer?, _ body: (AVSpeechContextImpl) -> SpeechError) -> Int32 {
    guard let ctx else { return SpeechError.notInitialized.rawValue }
    return body(Unmanaged<AVSpeechContextImpl>.fromOpaque(ctx).takeUnretainedValue()).rawValue
}
...
func avspeech_speak_to_memory(_ ctx: UnsafeMutableRawPointer?, _ text: UnsafePointer<CChar>?, _ callback: (@convention(c) (UnsafeMutableRawPointer?, UnsafePointer<Float>?, Int, Int32, Int32) -> Void)?, _ userdata: UnsafeMutableRawPointer?) -> Int32 {
    withContext(ctx) { impl in
        ...
        impl.synthesizer.write(impl.makeUtterance(for: String(cString: text))) { [weak impl] buffer in
            guard let impl,
                  ...
                  let floatData = pcmBuffer.floatChannelData else { return }
...
func avspeech_is_speaking(_ ctx: UnsafeMutableRawPointer?) -> Bool {
    ...
    return Unmanaged<AVSpeechContextImpl>.fromOpaque(ctx).takeUnretainedValue().synthesizer.isSpeaking
}
...
func avspeech_get_volume(_ ctx: UnsafeMutableRawPointer?, _ volume: UnsafeMutablePointer<Float>?) -> Int32 {
    withContext(ctx) { impl in
...
func avspeech_get_pitch(_ ctx: UnsafeMutableRawPointer?, _ pitch: UnsafeMutablePointer<Float>?) -> Int32 {
    withContext(ctx) { impl in
...
func avspeech_get_rate(_ ctx: UnsafeMutableRawPointer?, _ rate: UnsafeMutablePointer<Float>?) -> Int32 {
    withContext(ctx) { impl in
...
func avspeech_count_voices(_ ctx: UnsafeMutableRawPointer?, _ count: UnsafeMutablePointer<Int32>?) -> Int32 {
    withContext(ctx) { impl in
...
func avspeech_get_voice_name(_ ctx: UnsafeMutableRawPointer?, _ voiceId: Int32, _ name: UnsafeMutablePointer<UnsafePointer<CChar>?>?) -> Int32 {
    withContext(ctx) { impl in
...
func avspeech_get_voice_language(_ ctx: UnsafeMutableRawPointer?, _ voiceId: Int32, _ language: UnsafeMutablePointer<UnsafePointer<CChar>?>?) -> Int32 {
    withContext(ctx) { impl in
...
func avspeech_get_voice(_ ctx: UnsafeMutableRawPointer?, _ voiceId: UnsafeMutablePointer<Int32>?) -> Int32 {
    withContext(ctx) { impl in
...
func avspeech_get_channels(_ ctx: UnsafeMutableRawPointer?, _ channels: UnsafeMutablePointer<Int32>?) -> Int32 {
    withContext(ctx) { impl in
...
func avspeech_get_sample_rate(_ ctx: UnsafeMutableRawPointer?, _ sampleRate: UnsafeMutablePointer<Int32>?) -> Int32 {
    withContext(ctx) { impl in
...
func avspeech_get_bit_depth(_ ctx: UnsafeMutableRawPointer?, _ bitDepth: UnsafeMutablePointer<Int32>?) -> Int32 {
    withContext(ctx) { impl in
