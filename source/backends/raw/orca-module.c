...
static void
_g_dbus_codegen_marshal_BOOLEAN__OBJECT_STRING_VARIANT_BOOLEAN (
    GClosure     *closure,
    GValue       *return_value,
    unsigned int  n_param_values,
    const GValue *param_values,
    ...
    void         *marshal_data)
{
  typedef gboolean (*_GDbusCodegenMarshalBoolean_ObjectStringVariantBooleanFunc)
       (void *data1,
        GDBusMethodInvocation *arg_method_invocation,
        const gchar *arg_command_name,
        ...
        gboolean arg_notify_user,
        void *data2);
  _GDbusCodegenMarshalBoolean_ObjectStringVariantBooleanFunc callback;
  GCClosure *cc = (GCClosure*) closure;
  void *data1, *data2;
  gboolean v_return;
  ...
  callback = (_GDbusCodegenMarshalBoolean_ObjectStringVariantBooleanFunc)
    (marshal_data ? marshal_data : cc->callback);
...
/* ------------------------------------------------------------------------
 * Code for interface org.gnome.Orca.Module
 * ------------------------------------------------------------------------
 */
...
org_gnome_orca_module_method_marshal_execute_parameterized_command (
    ...
    void         *marshal_data)
{
  _g_dbus_codegen_marshal_BOOLEAN__OBJECT_STRING_VARIANT_BOOLEAN (closure,
    return_value, n_param_values, param_values, invocation_hint, marshal_data);
}
 ...
 * @error: Return location for error or %NULL
 *
 * Synchronously creates a proxy for the D-Bus interface <link linkend="gdbus-interface-org-gnome-Orca-Module.top_of_page">org.gnome.Orca.Module</link>. See g_dbus_proxy_new_sync() for more details.
 *
  ...
  GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    {
    case 1:
      interface = g_dbus_object_get_interface (G_DBUS_OBJECT (object), "org.gnome.Orca.Module");
  ...
  switch (prop_id)
    ...
    case 1:
      ...
      if (interface != NULL)
        ...
        {
          g_dbus_object_skeleton_remove_interface_by_name (G_DBUS_OBJECT_SKELETON (object), "org.gnome.Orca.Module");
        }
      break;
