...
__declspec(dllimport) uint32_t prism_spiel_abi_version(void)
    PRISM_WINELIB_NOEXCEPT;
__declspec(dllimport) PrismWinelibStatus prism_spiel_available(void)
    PRISM_WINELIB_NOEXCEPT;
...
__declspec(dllimport) PrismWinelibStatus prism_spiel_stop(PrismSpielInstance *h)
    PRISM_WINELIB_NOEXCEPT;
__declspec(dllimport) PrismWinelibStatus
prism_spiel_pause(PrismSpielInstance *h) PRISM_WINELIB_NOEXCEPT;
__declspec(dllimport) PrismWinelibStatus
prism_spiel_resume(PrismSpielInstance *h) PRISM_WINELIB_NOEXCEPT;
__declspec(dllimport) PrismWinelibStatus prism_spiel_is_speaking(
    PrismSpielInstance *h, int32_t *out) PRISM_WINELIB_NOEXCEPT;
__declspec(dllimport) PrismWinelibStatus prism_spiel_set_volume(
    PrismSpielInstance *h, float value) PRISM_WINELIB_NOEXCEPT;
__declspec(dllimport) PrismWinelibStatus prism_spiel_get_volume(
...
__declspec(dllimport) PrismWinelibStatus prism_spiel_set_pitch(
    PrismSpielInstance *h, float value) PRISM_WINELIB_NOEXCEPT;
__declspec(dllimport) PrismWinelibStatus
...
__declspec(dllimport) PrismWinelibStatus prism_spiel_count_voices(
    PrismSpielInstance *h, uint32_t *out) PRISM_WINELIB_NOEXCEPT;
__declspec(dllimport) PrismWinelibStatus prism_spiel_get_voice_name(
    PrismSpielInstance *h, uint32_t index, char *buf, uint32_t cap,
    uint32_t *needed) PRISM_WINELIB_NOEXCEPT;
__declspec(dllimport) PrismWinelibStatus prism_spiel_get_voice_language(
    PrismSpielInstance *h, uint32_t index, char *buf, uint32_t cap,
    uint32_t *needed) PRISM_WINELIB_NOEXCEPT;
__declspec(dllimport) PrismWinelibStatus prism_spiel_set_voice(
    PrismSpielInstance *h, uint32_t index) PRISM_WINELIB_NOEXCEPT;
__declspec(dllimport) PrismWinelibStatus prism_spiel_get_voice(
    PrismSpielInstance *h, uint32_t *out) PRISM_WINELIB_NOEXCEPT;
