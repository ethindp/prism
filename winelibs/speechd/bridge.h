...
PRISM_WINELIB_ABI uint32_t prism_speechd_abi_version(void)
    PRISM_WINELIB_NOEXCEPT;
PRISM_WINELIB_ABI PrismWinelibStatus prism_speechd_available(void)
    PRISM_WINELIB_NOEXCEPT;
PRISM_WINELIB_ABI PrismWinelibStatus prism_speechd_create(
...
PRISM_WINELIB_ABI PrismWinelibStatus prism_speechd_set_volume(
    PrismSpeechDispatcherInstance *h, float value) PRISM_WINELIB_NOEXCEPT;
PRISM_WINELIB_ABI PrismWinelibStatus prism_speechd_get_volume(
    PrismSpeechDispatcherInstance *h, float *out) PRISM_WINELIB_NOEXCEPT;
PRISM_WINELIB_ABI PrismWinelibStatus prism_speechd_set_rate(
    PrismSpeechDispatcherInstance *h, float value) PRISM_WINELIB_NOEXCEPT;
PRISM_WINELIB_ABI PrismWinelibStatus prism_speechd_get_rate(
    PrismSpeechDispatcherInstance *h, float *out) PRISM_WINELIB_NOEXCEPT;
PRISM_WINELIB_ABI PrismWinelibStatus prism_speechd_set_pitch(
    PrismSpeechDispatcherInstance *h, float value) PRISM_WINELIB_NOEXCEPT;
PRISM_WINELIB_ABI PrismWinelibStatus prism_speechd_get_pitch(
    PrismSpeechDispatcherInstance *h, float *out) PRISM_WINELIB_NOEXCEPT;
PRISM_WINELIB_ABI PrismWinelibStatus prism_speechd_refresh_voices(
    PrismSpeechDispatcherInstance *h) PRISM_WINELIB_NOEXCEPT;
PRISM_WINELIB_ABI PrismWinelibStatus prism_speechd_count_voices(
    PrismSpeechDispatcherInstance *h, uint32_t *out) PRISM_WINELIB_NOEXCEPT;
PRISM_WINELIB_ABI PrismWinelibStatus prism_speechd_get_voice_name(
    PrismSpeechDispatcherInstance *h, uint32_t index, char *buf, uint32_t cap,
    uint32_t *needed) PRISM_WINELIB_NOEXCEPT;
PRISM_WINELIB_ABI PrismWinelibStatus prism_speechd_get_voice_language(
    PrismSpeechDispatcherInstance *h, uint32_t index, char *buf, uint32_t cap,
    uint32_t *needed) PRISM_WINELIB_NOEXCEPT;
PRISM_WINELIB_ABI PrismWinelibStatus prism_speechd_set_voice(
    PrismSpeechDispatcherInstance *h, uint32_t index) PRISM_WINELIB_NOEXCEPT;
PRISM_WINELIB_ABI PrismWinelibStatus prism_speechd_get_voice(
    PrismSpeechDispatcherInstance *h, uint32_t *out) PRISM_WINELIB_NOEXCEPT;
